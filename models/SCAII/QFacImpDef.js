...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('QFacImpDef', {
    CONSECUTIVO: {
    ...
    sequelize,
    tableName: 'QFacImpDef',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "EqiFID_FKFacImpoDef",
        unique: true,
        fields: [
          { name: "FACTURAIMPODEF" },
        ]
      ...
      {
        name: "EqiFID_FKPedimento",
        fields: [
          { name: "PEDIMENTOIMPODEF" },
        ]
      },
      {
        name: "EqiFID_PKConsecutivo",
        unique: true,
        fields: [
          { name: "CONSECUTIVO" },
        ]
