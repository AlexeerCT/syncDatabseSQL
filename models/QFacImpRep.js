...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('QFacImpRep', {
    CONSECUTIVO: {
    ...
    sequelize,
    tableName: 'QFacImpRep',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "FimRep_FKFacturaImpo",
        unique: true,
        fields: [
          { name: "FACTURAIMPO" },
        ]
      ...
      {
        name: "FimRep_FKPedimento",
        fields: [
          { name: "PEDIMENTOIMPO" },
        ]
      },
      {
        name: "FimRep_FKPedImp_Remes",
        fields: [
          { name: "PEDIMENTOIMPO" },
          { name: "REMESA" },
        ]
